    ...
    <div className="px-4 py-3 bg-background flex justify-center">
      <div className="flex w-full max-w-[480px] min-w-[320px]">
        ...
        >
          ...
          {activeTab === "daily" && (
            <div className="absolute bottom-0 left-0 right-0 h-[3px] bg-gradient-to-r from-[#FF6C00] to-[#FFC107] rounded-full animate-shrinkLeftGrowLeft" />
          )}
        </button>
        ...
        >
          ...
          {activeTab === "rewire" && (
            <div className="absolute bottom-0 left-0 right-0 h-[3px] bg-gradient-to-r from-[#FF6C00] to-[#FFC107] rounded-full animate-shrinkRightGrowRight" />
          )}
        </button>
      </div>
    </div>
